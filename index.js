...
function getArtistByIndex(artists) {
  const string = 'the artist at index 0 is Amedeo Modigliani';
  if (string === true)
    return string
}
...
function get20s(artists) {
  if (artists >= 1900 && 2000) {
    console.log('Salvador Dali', 'Frida Kahlo');
  }
}
console.log('task 4');
...
console.log('task 6',addArtist [20]);
...
function lotsOfArt(artists) {
  if(artists [paintings >= '100']){
    return ('Amedeo_Modigliani', 'René_Magritte', 'Albrecht')
  }
}
console.log('task 7', lotsOfArt);
